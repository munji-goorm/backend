...
public class MapResponse {
    ...
    @Builder
    public MapResponse(String stationName, Float dmX, Float dmY, Integer khaiValue, String khaiState, Integer pm10Value, String pm10StateK, String pm10StateW, Integer pm25Value, String pm25StateK, String pm25StateW, Float o3Value, String o3State, Float coValue, String coState, Float no2Value, String no2State, Float so2Value, String so2State) {
